# pnnx model stat
# model inputshape = [1,3,416,416]f32
# FLOPS = 2.803G
# memory OPS = 44.942M
...
class Model(nn.Module):
    def __init__(self):
        ...
        archive = zipfile.ZipFile('yolo11n_ncnn_model/model.pnnx.bin', 'r')
        ...
        self.pnnx_188_data = self.load_pnnx_bin_as_parameter(archive, 'pnnx_188.data', (1,3549,), 'float32')
        self.pnnx_fold_anchor_points_1_data = self.load_pnnx_bin_as_parameter(archive, 'pnnx_fold_anchor_points.1.data', (1,2,3549,), 'float32')
        archive.close()
    ...
    def forward(self, v_0):
        ...
        v_106 = v_105.reshape(1, 128, 13, 13)
        v_107 = v_99.reshape(1, 128, 13, 13)
        ...
        v_238 = v_237.reshape(1, 80, 169)
        v_239 = torch.cat((v_218, v_228, v_238), dim=-1)
        v_240 = v_208.reshape(1, 4, 16, 3549)
        v_241 = torch.transpose(v_240, dim0=2, dim1=1)
        v_242 = F.softmax(v_241, dim=1)
        v_243 = self.model_23_dfl_conv(v_242)
        v_244 = v_243.reshape(1, 4, 3549)
        v_245 = self.pnnx_fold_anchor_points_1_data
        v_246, v_247 = torch.chunk(v_244, chunks=2, dim=1)
        v_248 = (v_245 - v_246)
        v_249 = (v_245 + v_247)
        v_250 = ((v_248 + v_249) / 2)
        v_251 = (v_249 - v_248)
        v_252 = torch.cat((v_250, v_251), dim=1)
        v_253 = (v_252 * v_189)
        v_254 = F.sigmoid(v_239)
        v_255 = torch.cat((v_253, v_254), dim=1)
        return v_255
...
def export_torchscript():
    ...
    mod.save("yolo11n_ncnn_model/model_pnnx.py.pt")
...
def export_onnx():
    ...
    torch.onnx.export(net, v_0, "yolo11n_ncnn_model/model_pnnx.py.onnx", export_params=True, operator_export_type=torch.onnx.OperatorExportTypes.ONNX_ATEN_FALLBACK, opset_version=13, input_names=['in0'], output_names=['out0'])
...
def export_pnnx():
    ...
    import pnnx
    pnnx.export(net, "yolo11n_ncnn_model/model_pnnx.py.pt", v_0)
